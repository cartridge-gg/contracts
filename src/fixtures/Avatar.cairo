...
@external
func test_generate_character{syscall_ptr: felt*, range_check_ptr}(seed: felt, bias: felt, dimension: felt, color: felt, bg_color: felt) -> (tokenURI_len: felt, tokenURI: felt*):
    alloc_locals
