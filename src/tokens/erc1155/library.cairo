...
// Not yet merged, taken from
// https://github.com/OpenZeppelin/cairo-contracts/pull/290
...
from src.tokens.erc1155.IERC1155Receiver import IERC1155_Receiver
from openzeppelin.security.safemath.library import SafeUint256
// from openzeppelin.utils.constants.library import (
from src.tokens.erc1155.constants import (
    IERC1155_ID,
...
namespace ERC1155 {
    ...
    func initializer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(uri_: felt) {
        _set_uri(uri_);
