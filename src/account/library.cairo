...
namespace Account:
    ...
    func set_plugin{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    func set_plugin_storage{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}(
        plugin : felt, key : felt, value : felt
    ):
